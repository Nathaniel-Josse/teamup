...
export default function LoginPage() {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
        ...
        <form className="flex flex-col items-center mt-4">
            ...
            <button type="submit" className="p-2 bg-blue-500 text-white rounded">S&apos;inscrire</button>
        </form>
        <div className="mt-4">
            <p className="text-sm">Déjà un compte ? <a href="/auth/login" className="text-blue-500">Se connecter</a></p>
        </div>
    </div>
    );
}