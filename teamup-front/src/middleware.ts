...
export function middleware(request: NextRequest) {
    ...
    if (process.env.NEXT_PUBLIC_NODE_ENV === 'development') {
        ...
        base-uri 'self';
        form-action 'self';
        font-src 'self' https://unpkg.com/leaflet@* https://cdn.jsdelivr.net/npm/leaflet@* data:font/;
        ...
        object-src 'none';
        base-uri 'self';
        font-src 'self' https://unpkg.com/leaflet@* https://cdn.jsdelivr.net/npm/leaflet@* data:;
        form-action 'self';
        frame-ancestors 'none';
        block-all-mixed-content;
        upgrade-insecure-requests;
