...
export function middleware(request: NextRequest) {
    ...
    if (process.env.NODE_ENV === 'development') {
        ...
        connect-src 'self' ${backendUrl} https://www.google.com https://unpkg.com/leaflet@* https://cdn.jsdelivr.net/npm/leaflet@*  https://tile.openstreetmap.org https://a.tile.openstreetmap.org https://b.tile.openstreetmap.org https://c.tile.openstreetmap.org;
